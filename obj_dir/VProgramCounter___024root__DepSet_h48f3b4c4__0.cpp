...
VL_INLINE_OPT void VProgramCounter___024root___sequent__TOP__0(VProgramCounter___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VProgramCounter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VProgramCounter___024root___sequent__TOP__0\n"); );
    // Body
    if (vlSelf->rst) {
        vlSelf->pc4 = 0U;
        vlSelf->pc = 0U;
    } else {
        vlSelf->pc4 = ((IData)(4U) + vlSelf->pc);
        vlSelf->pc = vlSelf->start;
    }
}
...
void VProgramCounter___024root___eval(VProgramCounter___024root* vlSelf) {
    ...
    if ((((IData)(vlSelf->clk) & (~ (IData)(vlSelf->__Vclklast__TOP__clk))) 
        ...
        VProgramCounter___024root___sequent__TOP__0(vlSelf);
    }
    // Final
